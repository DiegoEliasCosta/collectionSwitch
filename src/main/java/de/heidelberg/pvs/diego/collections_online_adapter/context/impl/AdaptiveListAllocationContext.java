...
public class AdaptiveListAllocationContext extends AbstractAdaptiveAllocationContext
		implements ListAllocationContext, AllocationContextUpdatable {

	ListAllocationOptimizer optimizer;
	
	public AdaptiveListAllocationContext(CollectionTypeEnum collectionType, ListAllocationOptimizer optimizer, int windowSize, int fullAnalysisThreshold,
