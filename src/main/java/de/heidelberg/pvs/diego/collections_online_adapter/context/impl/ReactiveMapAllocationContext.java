...
public class ReactiveMapAllocationContext extends AbstractAdaptiveAllocationContext implements MapAllocationContext {

	private MapAllocationOptimizer optimizer;

	public ReactiveMapAllocationContext(CollectionTypeEnum collectionType, MapAllocationOptimizer optimizer, int windowSize, int fullAnalysisThreshold,
